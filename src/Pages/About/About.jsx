    ...
    return (
        <div className="">
            ...
            <div className="">
                ...
                <h1 className=' md:text-4xl text-2xl text-white font-semibold mt-5 rajdhani-font'>Innovative Frontend Developer Focused on User-Centered, Responsive Web Solutions</h1>
                <p className="mt-2 md:text-xl text-gray-400 text-justify rubik-font"> Creative and detail-oriented Frontend Developer skilled in HTML, CSS, JavaScript, and modern frameworks like React. Experienced in building responsive, user-friendly interfaces and collaborating with cross-functional teams. Passionate about clean code, performance optimization, and delivering seamless user experiences. Eager to contribute to innovative and dynamic development projects</p>
            </div>
            {/* What i do */}
            ...
            {/* my number  */}
            <div className="grid md:grid-cols-3 mt-10 md:gap-25 gap-5">
