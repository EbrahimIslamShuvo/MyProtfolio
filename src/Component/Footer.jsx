...
const Footer = () => {
    return (
        <footer className="bg-white py-10 border-t mt-20">
            <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-10 text-center md:text-left">
                ...
                <div className="flex flex-col items-center md:items-start gap-3">
                    <h1 className="text-2xl font-semibold">MD. Ebrahim Islam Shuvo</h1>
                    ...
                    <div className="flex gap-4 text-xl text-black">
                        <a
                            ...
                            className="bg-gray-300 hover:bg-[#FF014F] hover:text-white duration-500 hover:-translate-y-2 p-3 rounded-full cursor-pointer"
                        >
                            <FaLinkedinIn />
                        </a>
                        <a
